...
DEVICE_FOLDER := device/amlogic/franklin
...
TARGET_BOOTLOADER_BOARD_NAME := u211
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 0x74000000
BOARD_USERDATAIMAGE_PARTITION_SIZE:= 0xFFFFFFFF
BOARD_CACHEIMAGE_PARTITION_SIZE := 0x46000000
BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_PARTITION_SIZE := 0x10000000
...
# Kernel
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x01080000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --second $(DEVICE_FOLDER)/kernel.dtb
